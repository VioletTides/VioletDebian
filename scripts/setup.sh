...
sudo apt install -y xserver-xorg-core xserver-xorg-video-intel xinit x11-xserver-utils
...
cp "$ROOT_DIR/config/alacritty/alacritty.yml" "$HOME/.config/alacritty/alacritty.yml"
